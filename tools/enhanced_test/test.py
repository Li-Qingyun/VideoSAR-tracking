...
def main():
    ...
    assert cfg.get('USE_MMDET', False) == False
    assert cfg.get('TRAIN_REID', False) == False
    from tools.enhanced_test.test_utils import single_gpu_test
